...
public class Post {
    ...
    public Post(int id_post, int id_user, String description_p, String media, String title_p, String imagePath, Date date_p, String post_type, int likes, String path, Category category_p) {
    ...
    public Post(int id_user, String description_p, String media, String title_p, String imagePath, Date date_p, String post_type, int likes, String path, Category category_p) {
        this.id_user = id_user;
        this.description_p = description_p;
        this.media = media;
        this.title_p = title_p;
