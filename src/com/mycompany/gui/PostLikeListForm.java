 ...
 * @author amine
 */
//public class PostLikeListForm extends BaseForm{
    
//    Form current;
//    public PostLikeListForm(Resources res){
...
//        ArrayList<PostLike>List = ServicePost.getInstance().displayPostLike(24);
...
//
//
//    private void addButton(Image img, PostLike postlike, Resources res) {    
//        int height = Display.getInstance().convertToPixels(11.5f);
//        int width = Display.getInstance().convertToPixels(14f);
//        Button image = new Button(img.fill(width, height));
//        image.setUIID("Label");
//        Container cnt = BorderLayout.west(image);
////        TextArea ta = new TextArea((postlike.getId_like()));
//TextArea ta = new TextArea(String.valueOf((int) postlike.getId_like()));
////System.out.println("aaaaaaaaaaaaaaaaaaaaaaaa"+ta);
//
//
//        ta.setUIID("NewsTopLine");
//        ta.setEditable(false);
//        Label categorynameTxt = new Label("category name : "+postlike.getId_like(),"NewsTopLine2" );
//        cnt.add(BorderLayout.CENTER, BoxLayout.encloseY(BoxLayout.encloseX(categorynameTxt)));
//        System.out.println("aaaaaaaaaaaaaaaaaaaaaaaa"+categorynameTxt);
//        
//        //DELETE BUTTON
...
////                if(ServiceCategory.getInstance().deleteCategory(cat.getId_category())) {
...
//             //new UpdateCategoryForm(res,cat).show();
//        });
//
//        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
//                BoxLayout.encloseX(categorynameTxt)));
//        add(cnt);
//        
//
//    }
