 ...
 * @author achref
 */
public class ModifyVideoForm extends BaseForm{
     public ModifyVideoForm(Resources res,Video v,Tutoriel t) {
        ...
        TextField titleTF = new TextField(v.getTitle()+"", "Video title", 20, TextField.ANY);
        TextField descriptionTF = new TextField(v.getDescription()+"", "Tutoriel description", 20, TextField.ANY);
        TextField pathimgTF = new TextField(v.getPathimage()+"", "Tutoriel pathimg", 20, TextField.ANY);
        TextField pathvidTF = new TextField(v.getPathvideo()+"", "Tutoriel pathvid", 20, TextField.ANY);
        ...
        submit.addActionListener((evt) -> {            
            if (vs.modifyVideo(new Video(v.getId_video() ,titleTF.getText(), descriptionTF.getText(), pathimgTF.getText(), pathvidTF.getText()),t)) {
                Dialog.show("Success", "Video Modified successfully", "Got it", null);
