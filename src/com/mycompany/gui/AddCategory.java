...
public class AddCategory extends BaseForm{
    ...
    public AddCategory(Resources res ) {
        ...
        TextField name_category = new TextField("", "Enter Category Name!!!");
        name_category.setUIID("TextFieldBlack");
        addStringValue("Category Name",name_category);
        ...
        btnAdd.addActionListener((e) ->{
            ...
            try {
//                if(name_category.getText() == ""){
                    if(name_category.getText().equals("")){
...
//                    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
                    ...
                    Category c = new Category(String.valueOf(name_category.getText().toString()));
                    System.out.println("Category data == "+c);
                    
                    //Calling AddCategory of service category  to add our data in the DATABASE 
                    ServiceCategory.getInstance().addCategory(c);
                    
                    iDialog.dispose();//To Cancle Loading After The Adding 
                    
                    //NOW WE MOVE ON TO CATEGORYLISTFORM
