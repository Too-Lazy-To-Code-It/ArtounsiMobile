...
public class AddComment extends BaseForm{
    private int id_post; // add a field to store the id_post value

     Form current;
     public AddComment(Resources res, int id_post){
     super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
     this.id_post = id_post; // store the id_post value in the field
...
c.setComment(comment.getText());
            ...
            System.out.println("Comment data == " + c);

            //Calling AddComment of service category...
            ServiceComment.getInstance().addComment(id_post,c);
