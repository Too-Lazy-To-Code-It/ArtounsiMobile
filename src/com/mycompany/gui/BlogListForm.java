 ...
 * @author amine
 */
public class BlogListForm extends BaseForm{
    Form current;
    public BlogListForm(Resources res){
    super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        ...
        RadioButton liste = RadioButton.createToggle("Explore", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Blog", barGroup);
...
new NewsfeedForm(res).show(); 
        ...
        ArrayList<Post>List = ServicePost.getInstance().displayBlog();
         for(Post post: List){
