...
public class ShowTutorielsForm extends BaseForm {

    public ShowTutorielsForm(Resources res) {
        ...
        List<Tutoriel> tutoriels = ts.fetchTutoriels();
        ...
        featured.addActionListener((e)->{
            new showfavorisTutorielsForm(res).show();
        });
