 ...
 * @author amine
 */
public class CategoryListForm extends BaseForm{
    
    Form current;
    public CategoryListForm(Resources res){
        ...
        ArrayList<Category>List = ServiceCategory.getInstance().displayCategory();
    ...
    private void addButton(Image img, Category cat, Resources res) {    
        ...
        TextArea ta = new TextArea(cat.getName_category());
        ta.setUIID("NewsTopLine");
        ta.setEditable(false);
        Label categorynameTxt = new Label("category name : "+cat.getName_category(),"NewsTopLine2" );
