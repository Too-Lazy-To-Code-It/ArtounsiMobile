...
public class TutorielService implements TutorielInterface {
    ...
    public void addTutoriel(Tutoriel t) {
        try {
            String req = "INSERT INTO `tutoriel`(`Title`,`Niveau`,`Description`, `PathImg`, `id_category`, `ID_user`) VALUES (?,?,?,?,?,?)";
    ...
    public List<Tutoriel> fetchTutoriels() {
        ...
        try {
            ...
            String req = "SELECT * FROM tutoriel as t,category as c,AllUsers as u where t.ID_Category=c.id_category and t.id_user=u.ID_User";
