 ...
 * @author achref
 */
public class showfavorisTutorielsForm extends BaseForm {
    public showfavorisTutorielsForm(Resources res) {
        super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Favoris Tutoriels");
        getContentPane().setScrollVisible(false);
          
        TutorielService ts = TutorielService.getInstance();
        List<Tutoriel> tutoriels = ts.fetchFavorisTutoriels();
       ...
       best.addActionListener((e)->{
            new showBestTutorielsForm(res).show();
        });
    }
